...
export const ApiEndpoints = Object.freeze({
  ...
  FIXED_DELAY_API: `${API_URL}/api/v1/fixed_delay_api`,
  RANDOM_DELAY_API: `${API_URL}/api/v1/random_delay_api`,
  FIXED_DELAY_SYNC_API: `${API_URL}/api/v1/fixed_delay_sync_api`,
  RANDOM_DELAY_SYNC_API: `${API_URL}/api/v1/random_delay_sync_api`,
