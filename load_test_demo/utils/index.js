...
export const endPoints = Object.freeze({
  ...
  API4: `${API_URL}/api/v1/api4`,
  API5: `${API_URL}/api/v1/api5`,
  API_WITH_HEADER_DATA: `${API_URL}/api/v1/apiWithHeaderData`,
  API_WITH_PATH_DATA: `${API_URL}/api/v1/apiWithPathData/{scenarioId}`,
  NORMAL_API: `${API_URL}/api/v1/normalApi`,
  NORMAL_SYNC_API: `${API_URL}/api/v1/normalSyncApi`,
  FIXED_DELAY_API: `${API_URL}/api/v1/fixedDelayApi`,
  RANDOM_DELAY_API: `${API_URL}/api/v1/randomDelayApi`,
  FIXED_DELAY_SYNC_API: `${API_URL}/api/v1/fixedDelaySyncApi`,
